...
export const Button: React.FC<ButtonProps> = ({ variant, size, icon, block, className, type = 'button', ...rest }) => (
  <button type={type} className={buttonClass({ variant, size, icon, block, className })} {...rest} />
);
