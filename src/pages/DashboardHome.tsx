...
export const DashboardHome: React.FC = () => {
  const { stats, stages, learnerStages, user, challengeById, openPractice, openStageTest } = useGame();
  ...
  // progress, WITHIN the learner's currently selected language track - so
  // "Continue Learning" never jumps into a different language's stage.
  ...
  // Achievements aggregate across every language the player has touched, not
  // just the one currently selected - it is a record of everything earned.
            ...
            <div className="relative z-10">
              ...
              {current && currentStatus ? (
                ...
                <>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6">
                    {allDone
                      ? 'Revisit any stage from the Learn page, drill specific topics in Challenges, or pick up a new language track.'
