...
export interface HealthResponse {
  ...
  stages: number;
  users: number;
  /** Never carries credentials - just whether the server has a remote compiler wired up. */
...
export const api = {
  ...
  async content(): Promise<{ stages: any[]; challenges: Challenge[]; hiddenLanguages?: string[] }> {
