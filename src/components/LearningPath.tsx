...
/**
 * The current language track's stages, in order. Each card shows lesson
 * progress and the state of the stage's coding test; the primary action
 * follows that state.
 *
 * Reads `learnerStages` (the selected language's own slice - see
 * GameContext) rather than the whole cross-language `stages`, so switching
 * languages on the Learn page immediately swaps which path this renders.
 */
