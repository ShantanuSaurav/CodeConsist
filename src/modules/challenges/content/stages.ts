...
/** Stage metadata. Challenges are attached by `./index.ts` once the batches are loaded. */
...
export const STAGE_META: StageMeta[] = [
  ...
  /* ---------------------------------------------------- language tracks */
  // These belong to their own tracks (see ./tracks.ts), each with its own
  // lock chain - they never sit behind Stage 10, and Stage 3 never waits on them.
  {
    id: 'stage-c1',
    index: '01',
    slug: 'c-fundamentals',
