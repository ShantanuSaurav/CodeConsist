...
const modules = import.meta.glob(['./**/*.ts', '!./index.ts', '!./spec.ts', '!./stages.ts', '!./tracks.ts'], { eager: true });
...
export { STAGE_META };
export { LANGUAGE_TRACKS, DEFAULT_TRACK_ID, trackById, trackForStageId } from './tracks';
