...
export const challenges: Challenge[] = [
  ...
  /* ------------------------------------------------------------ stage C1 */
  {
    ...
    stageId: 'stage-c1',
    isStageTest: true,
    title: 'Summing the even numbers in an array',
    type: 'fill_blank',
    difficulty: 'hard',
    language: 'c',
    prompt:
      'Fill in the blanks so this program prints the sum of the EVEN numbers in nums (8 + 12 + 4 = 24).',
    codeSnippet:
      '#include <stdio.h>\n' +
      '\n' +
      'int main(void) {\n' +
      '    int nums[6] = {3, 8, 5, 12, 7, 4};\n' +
      '    int sum = 0;\n' +
      ...
      '    return 0;\n' +
      '}',
    blanks: [{ answer: '0' }, { answer: '6' }, { answer: '0' }],
    hints: [
      'The loop needs to visit every index of a 6-element array, starting from the first one.',
      'A number is even exactly when it leaves a remainder of 0 after % 2.'
    ],
    explanation:
      'The loop must cover every index of the 6-element array, so it starts at 0 and runs while i < 6. `nums[i] % 2 == 0` is true exactly for even numbers, so only 8, 12 and 4 are added into sum, giving 24. This combines a full array traversal with a conditional accumulator - the two most common building blocks from this stage.',
    xpReward: 150,
    tags: ['arrays', 'loops', 'conditionals', 'stage-test']
  },
  ...
  /* ---------------------------------------------------------- stage CPP1 */
  {
    ...
    stageId: 'stage-cpp1',
    isStageTest: true,
    title: 'Counting values above a threshold',
    type: 'fill_blank',
    difficulty: 'hard',
    language: 'cpp',
    prompt:
      'Fill in the blanks so this program counts how many numbers in nums are greater than 5, and prints that count (3 - for 9, 15 and 11).',
    codeSnippet:
      '#include <iostream>\n' +
      '#include <vector>\n' +
      'using namespace std;\n' +
      ...
      '    return 0;\n' +
      '}',
    blanks: [{ answer: '0' }, { answer: '5' }, { answer: '++', alternatives: ['+= 1'] }],
    hints: [
      'A counter needs to start at zero before the loop can add to it.',
      'Only 9, 15 and 11 are greater than 5 in this list - 4 and 2 are not.'
    ],
    explanation:
      'count starts at 0 so it has something valid to add to. The range-based for loop checks every element against the threshold 5, and `count++` (or the equivalent `count += 1`) fires only when `n > 5` holds - true for 9, 15 and 11, giving a final count of 3.',
    xpReward: 150,
    tags: ['vector', 'loops', 'conditionals', 'stage-test']
  }
];
