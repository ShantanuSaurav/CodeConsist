...
export const DashboardHome: React.FC = () => {
  const { stats, stages, learnerStages, user, challengeById } = useSession();
                ...
                <>
                  ...
                  <div className="flex flex-wrap gap-3">
                    <button
                      type="button"
                      onClick={() =>
                        current.state === 'Test pending' ? intents.openStageTest(current.id) : intents.openPractice(current.id)
                      }
        ...
        <div className="space-y-8">
          ...
          <div className={`${CARD} p-6`}>
            <div className="flex justify-between items-center mb-6">
              ...
              <Link to={ROUTES.achievements} className="text-xs text-[var(--color-secondary)] hover:underline">
                View All
              </Link>
            </div>
